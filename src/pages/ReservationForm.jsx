...
function ReservationForm() {
  ...
  const [reservationSuccess, setReservationSuccess] = useState(null); // Stores the created reservation data
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Assuming your API returns the created reservation
      const createdReservation = response.data || response;

      alert(" Reservation created successfully!");
      setReservationSuccess(createdReservation);
  ...
  if (reservationSuccess) {
    ...
    const selectedTable = tables.find(
      (t) =>
        (t._id || t.id) === (reservation.table_id?._id || reservation.table_id),
    ) || { table_number: "N/A" };
    ...
    return (
      <main className="mx-auto max-w-2xl px-6 py-12">
        <div
          ref={printRef}
          className="bg-white rounded-3xl shadow-2xl p-10 max-w-md mx-auto"
        >
          ...
          <div className="space-y-5 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium">
                {reservation._id?.slice(-8) || "Pending"}
              </span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="text-center text-xs text-gray-500 mt-10">
            Thank you for choosing Cloud9 Pub!
            <br />
        ...
        <div className="bg-[#0e0c0a] px-10 py-12 text-white">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-amber-400 mt-1 text-lg">
                Cloud9 Pub • Phnom Penh
              </p>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full rounded-2xl border border-gray-300 px-6 py-4 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none"
                  required
                />
              </div>
          ...
          <div className="pt-6">
            <button
              ...
              className="w-full rounded-2xl bg-amber-600 cursor-pointer py-5 text-xl font-semibold text-white hover:bg-amber-700 disabled:bg-gray-400 transition-all active:scale-[0.98] shadow-lg shadow-amber-600/30"
            >
